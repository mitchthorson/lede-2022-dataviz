...
This is a starter template for a simple project to build a scrollytelling scatterplot with D3 based on [this Gapminder chart](https://www.gapminder.org/tools/#$chart-type=bubbles&url=v1).
